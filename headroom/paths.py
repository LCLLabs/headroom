...
_SESSION_DELTA_LOG_DIR = "sessions"
_BIN_DIR = "bin"
...
def session_delta_log_dir() -> Path:
    """Return the directory used for opt-in per-session message delta logs."""

    return log_dir() / _SESSION_DELTA_LOG_DIR
